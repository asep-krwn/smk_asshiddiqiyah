...
<head>
    ...
    <title>SMK ASSHIDDIQIYAH GARUT - Selamat Datang di SMK ASSHIDDIQIYAH</title>
    <link rel="shorcut icon" href="<?php echo base_url() . 'assets/images/smk_logo.png' ?>">
    <!-- Bootstrap CSS -->
                ...
                <div class="col-xs-6 col-sm-8 col-md-9">
                    <div class="header-top_address">
                        <div class="header-top_list">
                            <span class="icon-phone"></span>(0262) 224488
                        </div>
                        <div class="header-top_list">
                            <span class="icon-envelope-open"></span>smkasshiddiqiyah21@gmail.com
                        </div>
                        <div class="header-top_list">
                            <span class="icon-location-pin"></span>Garut, Jawa Barat, INA.
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <nav class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded">
                        ...
                        <a href="<?php echo site_url(''); ?>" class="navbar-brand nav-brand2"><img class="img img-responsive" width="90px;" src="<?php echo base_url() . 'theme/images/smk.png' ?>"></a>
    ...
    <section class="clearfix about about-style2">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <h3 class="text-center mt-5"><b>Jurusan</b></h3>
                <div class="d-flex my-4 align-items-center justify-content-center w-100">
                    <div class="col-md-4 d-flex flex-column align-items-center justify-content-center">
                        <img width="100px;" style="margin-right: 10px;" src="<?php echo base_url() . 'assets/images/smk_logo.png' ?>">
                        <span class="mt-4">
                            Teknik Informarika
                        </span>
                    </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="foot-logo">
                        ...
                        <p><?php echo date('Y'); ?> © copyright <br>SMK ASSHIDDIQIYAH <br>All rights reserved.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="sitemap">
                ...
                <div class="col-md-3">
                    <div class="address">
                        <h3>Hubungi Kami</h3>
                        <p>Email:smkasshiddiqiyah21@gmail.com <br> Phone:(0262) 224488</p>
                        <ul class="footer-social-icons">
                            <li><a href="https://web.facebook.com/smkasshiddiqiyahgarut/?_rdc=1&_rdr"><i class="fa fa-facebook fa-fb" aria-hidden="true"></i></a></li>
                            <li><a href="https://www.instagram.com/smk_asshiddiqiyah_garut/"><i class="fa fa-instagram fa-in" aria-hidden="true"></i></a></li>
